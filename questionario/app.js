(() => {
  ...
  function syncResponsiveLayout() {
    ...
    if (mobile) {
      ...
      if (header) root.style.setProperty("--form-header-height", `${Math.ceil(header.getBoundingClientRect().height)}px`);
      if (footer) root.style.setProperty("--form-footer-height", `${Math.ceil(footer.getBoundingClientRect().height)}px`);
    } else {
      root.style.removeProperty("--form-header-height");
      root.style.removeProperty("--form-footer-height");
    }
  ...
  function installResponsiveMapFix() {
    ...
    if (window.ResizeObserver) {
      ...
      [document.getElementById("formMap"), document.querySelector(".hero"), document.querySelector(".institutional-footer")]
        .filter(Boolean)
